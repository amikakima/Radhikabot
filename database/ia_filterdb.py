...
custom_caption = "Movie Channel: @MovieScreenPictures\nBackup: @linktoallchannel"
async def save_file(media):
    ...
    # Combine default caption with custom caption
    default_caption = media.caption.html if media.caption else ""
    combined_caption = f"{default_caption}\n\n{custom_caption}" if default_caption else custom_caption
